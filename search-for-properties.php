...
<body>
  ...
  <section class="site-hero overlay" style="background-image: url(img/home3.jpg)">
    <div class="container">
      <div class="row site-hero-inner align-items-center">
        <div class="col-md-7 text-left ml-auto">
          <h1 class="heading" data-aos="fade-up">Search for Properties</h1>
          <p class="sub-heading mb-5" data-aos="fade-up" data-aos-delay="100">We help you find the home of your dreams,
            the property that fits your lifestyle.</p>
          <!-- <p data-aos="fade-up" data-aos-delay="100"><a href="contact.php" class="btn uppercase btn-primary mr-md-2 mr-0 mb-3 d-sm-inline d-block">Get In Touch</a> <a href="contact.php" class="btn uppercase btn-outline-light d-sm-inline d-block">Download</a></p> -->
        </div>
      </div>
  ...
  <section class="section visit-section" id="next-section">
    <div style="margin-left: 5%; margin-right: 5%;">
      <iframe src="https://smartmls.mlsmatrix.com/Matrix/public/IDX.aspx?idx=973c232" width="100%" height="1600px"
  ...
  <!-- <section class="section">
    ...
    <section class="section">
        <div class="container" style="height: 1500px; width:1000px;">
            <iframe src="https://smartmls.mlsmatrix.com/Matrix/public/IDX.aspx?idx=973c232" width="100%" height="100%" frameborder="0" marginwidth="0" marginheight="0"></iframe>        
          </div>    
    </section> -->
  <!-- END section -->
